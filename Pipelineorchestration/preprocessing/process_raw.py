...
class Preprocess:
    ...
    Issue: https://github.com/maxpumperla/elephas/issues/47
    ...
    def __init__(self, spark, spark_context: pyspark.SparkContext):
        ...
        self._load_path = "dbfs:/mnt/FileStore/raw/"
        self._save_path = "dbfs:/pre_processed/"
    ...
    def process_csv(self):
      ...
      #  spark = SparkSession.builder.master('local').\
       #         appName('app').getOrCreate()
        ...
        data_csv = self.spark.createDataFrame(parsed,schema=common_event)
    ...
    def process_json(self):
        ...
        raw = self.spark.sparkContext.textFile(self._load_path+"/json/*/NASDAQ/*.txt")
